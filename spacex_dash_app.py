...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df.groupby('Launch Site')['class'].value_counts().reset_index(name='Count of Class')
        filtered_df = filtered_df[filtered_df['Launch Site']==entered_site]
        fig = px.pie(filtered_df, values='Count of Class', 
        names='class',
        title='Total Success launch by site '+ entered_site)
        return fig
